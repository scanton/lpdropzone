(function() {
  var channels, clearRequireSave, delay, delayInterval, id, id3d, requireSave, saveCaption, saveName, saveRequired, saveTitle, socket;
  ...
  requireSave = function() {
    ...
    saveRequired = true;
    b = $('.save-button');
    b.removeClass('changes-saved');
    return b.text('Save Changes');
  };
  ...
  clearRequireSave = function() {
    ...
    saveRequired = false;
    b = $('.save-button');
    b.addClass('changes-saved');
    return b.text('Changes Saved');
  };

  saveCaption = function(file, caption) {
    requireSave();
    return delay('caption', function() {
